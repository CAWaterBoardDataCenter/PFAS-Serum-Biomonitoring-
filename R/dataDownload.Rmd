...
```{r}
# download system area boundary shapefile https://gis.data.ca.gov/datasets/fbba842bf134497c9d611ad506ec48cc?geometry=-148.883%2C31.064%2C-89.601%2C43.271 
tempSABL <- tempfile()
download.file("https://gispublic.waterboards.ca.gov/portalserver/rest/services/Drinking_Water/California_Drinking_Water_System_Area_Boundaries/FeatureServer/0/query?where=1%3D1&outFields=*&outSR=4326&f=json", tempSABL)
unzip(tempSABL,exdir = "temp")

rm(tempspa) # remove temp file

# read system boundary layer shapefile into R
